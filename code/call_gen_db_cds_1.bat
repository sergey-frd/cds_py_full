...
SET src_clone_path=%out_base_root%\w01
SET release_clone_path=%out_base_root%\w01
...
SET in_html_base=\\Fileril103\dev\Objects\cpss\bin_history\UG\Ug_180529\CPSS_User_Guide-Responsive_HTML5
rem SET in_html_DXCH=\\Fileril103\dev\Objects\cpss\bin_history\UG\Ug_180529\CPSS_User_Guide-DxCh
SET in_html_DXCH=\\Fileril103\dev\Objects\cpss\bin_history\UG\Ug_180529\CPSS_User_Guide-Responsive_HTML5
SET in_html_PIPE=\\Fileril103\dev\Objects\cpss\bin_history\UG\Ug_180529\CPSS_User_Guide_PIPE-Responsive_HTML5
...
REM SET CONF_DOXY4UG=%tool_DoxyGen%\conf_doxy4ug_family_317_1.json

SET CONF_GEN_CDS=c:\Git\ws01\cds\code\gen_db_cds_3.json

ECHO "CONF_GEN_CDS=%CONF_GEN_CDS%

::echo  "%PYTHON_PATH% c:\Git\ws01\cds\code\gen_cds_2.py %CONF_GEN_CDS% >%LOG_DIR%\gen_cds_2.txt"
::       %PYTHON_PATH% c:\Git\ws01\cds\code\gen_cds_2.py %CONF_GEN_CDS%  


SET CONF_GEN_CDS=c:\Git\ws01\cds\code\data_cds_1.json
echo  "%PYTHON_PATH% c:\Git\ws01\cds\code\w_json_10.py %CONF_GEN_CDS% >%LOG_DIR%\w_json_x.txt"
       %PYTHON_PATH% c:\Git\ws01\cds\code\w_json_10.py %CONF_GEN_CDS%  

:: >db_180809_all_1_3.txt 2>&1


       rem >%LOG_DIR%\main_ug_api.txt  
